...
print("k-NN Red Training Accuracy: ", metrics.accuracy_score(y_trainR, y_predR_training))
...
#Model evaluation
print("k-NN Red Testing Accuracy: ", metrics.accuracy_score(y_testR, y_predR_testing))
...
# Implementing k-NN model
clfG= KNeighborsClassifier(n_neighbors=3)
...
#Model evaluation
from sklearn import metrics
print("k-NN Green Training Accuracy: ", metrics.accuracy_score(y_trainG, y_predG_training))
# print("Training Precision: ", metrics.precision_score(y_trainR,y_predR_training))
# print("Training Recall: ",metrics.recall_score(y_trainR,y_predR_training))

#Model evaluation
print("k-NN Green Testing Accuracy: ", metrics.accuracy_score(y_testG, y_predG_testing))
# print("Testing Precision: ", metrics.precision_score(y_testR,y_predR_testing))
# print("Testing Recall: ",metrics.recall_score(y_testR,y_predR_testing))
...
#Model evaluation
from sklearn import metrics
print("k-NN Blue Training Accuracy: ", metrics.accuracy_score(y_trainB, y_predB_training))
# print("Training Precision: ", metrics.precision_score(y_trainR,y_predR_training))
# print("Training Recall: ",metrics.recall_score(y_trainR,y_predR_training))

#Model evaluation`
print("k-NN Blue Testing Accuracy: ", metrics.accuracy_score(y_testB, y_predB_testing))
# print("Testing Precision: ", metrics.precision_score(y_testR,y_predR_testing))
# print("Testing Recall: ",metrics.recall_score(y_testR,y_predR_testing))
...
# pyplot.savefig('KNN_testing.png')
# accuracy_score(y_testR,majority_votes_testing)
...
# pyplot.savefig('kNN_training.png')
